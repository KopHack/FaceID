"""
Django settings for PytonSite project.
...
SECRET_KEY = 'django-insecure-er-*++wo6nvjc5#ih206e$n!!fk%+3-8r4akxgabqs=9+ryb1f'
...
WSGI_APPLICATION = 'PytonSite.wsgi.application'
